...
public abstract class Renderer {
  ...
  private List<IBrowserWrapper> browserList = new ArrayList<IBrowserWrapper>();
   ...
   */
  public abstract void render(IBrowserWrapper browser);

  /** Renders the current state managed by the renderer for each browser. */
  public synchronized void render() {
    for (IBrowserWrapper browser : browserList) {
      this.render(browser);
    }
  }
   ...
   */
  public synchronized void addBrowser(IBrowserWrapper browser) {
   ...
   */
  public synchronized void removeBrowser(IBrowserWrapper browser) {
